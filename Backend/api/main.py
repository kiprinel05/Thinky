...
try:
    ...
    app.include_router(describe_router, prefix="/api/v1")
    print("[OK] describe_router loaded successfully")
except Exception as e:
    print(f"[ERROR] Error loading describe_router: {e}")
    import traceback
    traceback.print_exc()
...
try:
    ...
    print("[OK] pattern_router loaded successfully")
except Exception as e:
    print(f"[ERROR] Error loading pattern_router: {e}")
    import traceback
    traceback.print_exc()
...
try:
    ...
    print("[OK] leaderboard_router loaded successfully")
except Exception as e:
    print(f"[ERROR] Error loading leaderboard_router: {e}")
    import traceback
    traceback.print_exc()
