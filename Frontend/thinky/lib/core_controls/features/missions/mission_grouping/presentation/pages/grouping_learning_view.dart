...
import '../../domain/grouping_lesson_content.dart';

class GroupingLearningView extends StatefulWidget {
  final VoidCallback onDone;

  const GroupingLearningView({super.key, required this.onDone});

  @override
  State<GroupingLearningView> createState() => _GroupingLearningViewState();
}

class _GroupingLearningViewState extends State<GroupingLearningView> {
  ...
  void _nextPage() {
    if (_currentPage < groupingLessonCards.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLast = _currentPage == groupingLessonCards.length - 1;
            ...
            children: [
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemCount: groupingLessonCards.length,
                  onPageChanged: _onPageChanged,
                  itemBuilder: (context, index) {
                    final card = groupingLessonCards[index];
                    return _LessonPage(
                      card: card,
                      index: index,
                      colors: colors,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isLast) ...[
                        PrimaryButton(
                          text: GroupingSorting.backToMissions,
                        ...
                        PrimaryButton(
                          text: GroupingSorting.lessonNext,
                          onPressed: _nextPage,
                        ),
                        const SizedBox(height: AppDimens.sm),
                        Center(
  ...
  Widget _buildProgressBar(AppColorsExtension colors) {
    final progress = (_currentPage + 1) / groupingLessonCards.length;
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                '${_currentPage + 1} / ${groupingLessonCards.length}',
                style: GoogleFonts.alata(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildDotIndicator() {
    return Row(
      ...
      children: List.generate(groupingLessonCards.length, (i) {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        GroupingSorting.lessonDidYouKnow,
                        style: GoogleFonts.alata(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          color: isDark
