...
import '../../domain/quiz_lesson_content.dart';
import '../widgets/quiz_widgets.dart';

class QuizLearningView extends StatefulWidget {
  final VoidCallback onDone;

  const QuizLearningView({super.key, required this.onDone});

  @override
  State<QuizLearningView> createState() => _QuizLearningViewState();
}

class _QuizLearningViewState extends State<QuizLearningView> {
  ...
  void _nextPage() {
    if (_currentPage < quizLessonCards.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLast = _currentPage == quizLessonCards.length - 1;
        ...
        SafeArea(
          child: Column(
            children: [
              ...
              const SizedBox(height: AppDimens.sm),
              // PageView with professor + card
              Expanded(
                child: PageView.builder(
                  controller: _pageController,
                  itemCount: quizLessonCards.length,
                  onPageChanged: _onPageChanged,
                  itemBuilder: (context, index) {
                    final card = quizLessonCards[index];
                    return _LessonPage(
                      card: card,
                      index: index,
                      colors: colors,
  ...
  Widget _buildProgressBar(AppColorsExtension colors) {
    final progress = (_currentPage + 1) / quizLessonCards.length;
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                '${_currentPage + 1} / ${quizLessonCards.length}',
                style: GoogleFonts.alata(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildDotIndicator() {
    return Row(
      ...
      children: List.generate(quizLessonCards.length, (i) {
...
/// Each page in the PageView: professor head + scrollable card, centered.
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Card overlaps professor slightly
            Transform.translate(
