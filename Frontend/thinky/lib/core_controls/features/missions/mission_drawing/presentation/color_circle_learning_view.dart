...
import '../domain/color_circle_lesson_content.dart';

class ColorCircleLearningView extends StatefulWidget {
  final VoidCallback onDone;

  const ColorCircleLearningView({super.key, required this.onDone});

  @override
  State<ColorCircleLearningView> createState() =>
      _ColorCircleLearningViewState();
}

class _ColorCircleLearningViewState extends State<ColorCircleLearningView> {
  ...
  void _nextPage() {
    if (_currentPage < colorCircleLessonCards.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLast = _currentPage == colorCircleLessonCards.length - 1;
            ...
            children: [
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemCount: colorCircleLessonCards.length,
                  onPageChanged: _onPageChanged,
                  itemBuilder: (context, index) {
                    final card = colorCircleLessonCards[index];
                    return _LessonPage(
                      card: card,
                      index: index,
                      colors: colors,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isLast) ...[
                        PrimaryButton(
                          text: Drawing.colorBackToMissions,
  ...
  Widget _buildProgressBar(AppColorsExtension colors) {
    final progress = (_currentPage + 1) / colorCircleLessonCards.length;
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                '${_currentPage + 1} / ${colorCircleLessonCards.length}',
                style: GoogleFonts.alata(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildDotIndicator() {
    return Row(
      ...
      children: List.generate(colorCircleLessonCards.length, (i) {
