...
import '../domain/draw_shapes_lesson_content.dart';

class DrawShapesLearningView extends StatefulWidget {
  final VoidCallback onDone;

  const DrawShapesLearningView({super.key, required this.onDone});

  @override
  State<DrawShapesLearningView> createState() => _DrawShapesLearningViewState();
}

class _DrawShapesLearningViewState extends State<DrawShapesLearningView> {
  ...
  void _nextPage() {
    if (_currentPage < drawShapesLessonCards.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLast = _currentPage == drawShapesLessonCards.length - 1;
            ...
            children: [
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemCount: drawShapesLessonCards.length,
                  onPageChanged: _onPageChanged,
                  itemBuilder: (context, index) {
                    final card = drawShapesLessonCards[index];
                    return _LessonPage(
                      card: card,
                      index: index,
                      colors: colors,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isLast) ...[
                        PrimaryButton(
                          text: Drawing.shapesBackToMissions,
  ...
  Widget _buildProgressBar(AppColorsExtension colors) {
    final progress = (_currentPage + 1) / drawShapesLessonCards.length;
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                '${_currentPage + 1} / ${drawShapesLessonCards.length}',
                style: GoogleFonts.alata(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildDotIndicator() {
    return Row(
      ...
      children: List.generate(drawShapesLessonCards.length, (i) {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        Drawing.shapesLessonDidYouKnow,
                        style: GoogleFonts.alata(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          color: isDark
