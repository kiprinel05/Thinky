...
import '../../domain/pixy_learns_lesson_content.dart';

class PixyLearnsLearningView extends StatefulWidget {
  final VoidCallback onDone;

  const PixyLearnsLearningView({super.key, required this.onDone});

  @override
  State<PixyLearnsLearningView> createState() =>
      _PixyLearnsLearningViewState();
}

class _PixyLearnsLearningViewState extends State<PixyLearnsLearningView> {
  ...
  void _nextPage() {
    if (_currentPage < pixyLearnsLessonCards.length - 1) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLast = _currentPage == pixyLearnsLessonCards.length - 1;
            ...
            children: [
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemCount: pixyLearnsLessonCards.length,
                  onPageChanged: _onPageChanged,
                  itemBuilder: (context, index) {
                    final card = pixyLearnsLessonCards[index];
                    return _LessonPage(
                      card: card,
                      index: index,
                      colors: colors,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (isLast) ...[
                        PrimaryButton(
                          text: PixyLearnsTexts.continueMissions,
                        ...
                        PrimaryButton(
                          text: PixyLearnsTexts.lessonNext,
                          onPressed: _nextPage,
                        ),
                        const SizedBox(height: AppDimens.sm),
                        Center(
  ...
  Widget _buildProgressBar(AppColorsExtension colors) {
    final progress = (_currentPage + 1) / pixyLearnsLessonCards.length;
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                '${_currentPage + 1} / ${pixyLearnsLessonCards.length}',
                style: GoogleFonts.alata(
                  fontSize: 12,
                  fontWeight: FontWeight.w700,
  ...
  Widget _buildDotIndicator() {
    return Row(
      ...
      children: List.generate(pixyLearnsLessonCards.length, (i) {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        PixyLearnsTexts.lessonDidYouKnow,
                        style: GoogleFonts.alata(
                          fontSize: 12,
                          fontWeight: FontWeight.w700,
                          color: isDark
